...
for audio_file in audio_files:
    ...
    # Apply voice restoration using Sox with the Adobe Audition-like profile
    subprocess.call(['sox', audio_file, restored_file, 'noiseprof audio.noiseprof -n noise -nr'])
